...
public class TableUserPointDe extends SqlGenerater {

	private SqlWork work ;

	public TableUserPointDe(SqlWork work){
		this.work=work;
	}
	...
	public String localGetStr(){
		...
		sb.append(SqlGenerater.in.getTableUser());
		sb.append(SqlGenerater.in.getPoint());
		return sb.toString();
	}
}
